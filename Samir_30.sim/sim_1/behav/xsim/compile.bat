...
REM
REM Generated by Vivado on Fri Jan 16 13:34:32 +0100 2026
...
echo "xvhdl --incr --relax -prj RgbLed_tb_vhdl.prj"
call xvhdl  --incr --relax -prj RgbLed_tb_vhdl.prj -log xvhdl.log
